  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-gray-900 mb-2">Durable Advisor</h1>
          <p className="text-gray-600">Your AI business coach for strategic growth</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 mb-6">
          ...
          <div className="space-y-4">
            {biz.weeklyPlan.tasks.map((item, idx) => (
              <div key={idx} className="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition-colors cursor-pointer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-xl border border-purple-100">
            ...
            <div className="text-sm text-gray-600">Increase in Perceived Platform Value</div>
          </div>
        </div>
      </div>
    </div>
